...
-- Các mã MAHP mới từ HP007 trở đi, đảm bảo MADV phải tồn tại (ví dụ: CNTT, KT, VL, HH)
INSERT INTO HOCPHAN (MAHP, TENHP, SOTC, STLT, STTH, MADV) 
VALUES ('HP007', 'Nguyên lý Hệ điều hành', 3, 30, 15, 'CNTT');

INSERT INTO HOCPHAN (MAHP, TENHP, SOTC, STLT, STTH, MADV) 
VALUES ('HP008', 'Xác suất Thống kê', 3, 45, 0, 'KT');

INSERT INTO HOCPHAN (MAHP, TENHP, SOTC, STLT, STTH, MADV) 
VALUES ('HP009', 'Hóa phân tích', 3, 30, 15, 'HH');

INSERT INTO HOCPHAN (MAHP, TENHP, SOTC, STLT, STTH, MADV) 
VALUES ('HP010', 'Điện học cơ bản', 3, 30, 15, 'VL');

INSERT INTO HOCPHAN (MAHP, TENHP, SOTC, STLT, STTH, MADV) VALUES ('HP011', 'Lập trình Java', 4, 45, 30, 'CNTT');
INSERT INTO HOCPHAN (MAHP, TENHP, SOTC, STLT, STTH, MADV) VALUES ('HP012', 'Cơ sở dữ liệu', 3, 45, 15, 'CNTT');
INSERT INTO HOCPHAN (MAHP, TENHP, SOTC, STLT, STTH, MADV) VALUES ('HP013', 'Mạng máy tính', 3, 30, 15, 'CNTT');
INSERT INTO HOCPHAN (MAHP, TENHP, SOTC, STLT, STTH, MADV) VALUES ('HP014', 'Phân tích thiết kế hệ thống', 3, 45, 0, 'CNTT');

INSERT INTO HOCPHAN (MAHP, TENHP, SOTC, STLT, STTH, MADV) 
VALUES ('HP015', 'Thiết kế Web', 3, 30, 15, 'CNTT');

INSERT INTO HOCPHAN (MAHP, TENHP, SOTC, STLT, STTH, MADV) 
VALUES ('HP016', 'Trí tuệ nhân tạo', 3, 45, 15, 'CNTT');

-- GV001 (CNTT) dạy HP007 (CNTT)
INSERT INTO MOMON (MAMM, MAHP, MAGV, HK, NAM, NGAYBD) 
VALUES ('MM010', 'HP007', 'GV001', 1, '2024-2025', TO_DATE('2024-09-01', 'YYYY-MM-DD'));

-- GV005 (KT) dạy HP008 (KT)
INSERT INTO MOMON (MAMM, MAHP, MAGV, HK, NAM, NGAYBD) 
VALUES ('MM011', 'HP008', 'GV005', 1, '2024-2025', TO_DATE('2024-09-01', 'YYYY-MM-DD'));

-- GV004 (HH) dạy HP009 (HH)
INSERT INTO MOMON (MAMM, MAHP, MAGV, HK, NAM, NGAYBD) 
VALUES ('MM012', 'HP009', 'GV004', 2, '2024-2025', TO_DATE('2025-01-15', 'YYYY-MM-DD'));

-- GV003 (VL) dạy HP010 (VL)
INSERT INTO MOMON (MAMM, MAHP, MAGV, HK, NAM, NGAYBD) 
VALUES ('MM013', 'HP010', 'GV003', 2, '2024-2025', TO_DATE('2025-01-15', 'YYYY-MM-DD'));

INSERT INTO MOMON (MAMM, MAHP, MAGV, HK, NAM, NGAYBD) 
VALUES ('MM014', 'HP011', 'GV001', 2, '2024-2025', TO_DATE('2025-05-25', 'YYYY-MM-DD'));

INSERT INTO MOMON (MAMM, MAHP, MAGV, HK, NAM, NGAYBD) 
VALUES ('MM015', 'HP012', 'GV002', 2, '2024-2025', TO_DATE('2025-05-25', 'YYYY-MM-DD'));

INSERT INTO MOMON (MAMM, MAHP, MAGV, HK, NAM, NGAYBD) 
VALUES ('MM016', 'HP013', 'GV001', 2, '2024-2025', TO_DATE('2025-05-25', 'YYYY-MM-DD'));

INSERT INTO MOMON (MAMM, MAHP, MAGV, HK, NAM, NGAYBD) 
VALUES ('MM017', 'HP014', 'GV002', 2, '2024-2025', TO_DATE('2025-05-25', 'YYYY-MM-DD'));

INSERT INTO MOMON (MAMM, MAHP, MAGV, HK, NAM, NGAYBD) 
VALUES ('MM018', 'HP015', 'GV001', 2, '2024-2025', TO_DATE('2025-06-15', 'YYYY-MM-DD'));

INSERT INTO MOMON (MAMM, MAHP, MAGV, HK, NAM, NGAYBD) 
VALUES ('MM019', 'HP016', 'GV002', 2, '2024-2025', TO_DATE('2025-06-15', 'YYYY-MM-DD'));
INSERT INTO MOMON (MAMM, MAHP, MAGV, HK, NAM, NGAYBD) 
VALUES ('MM020', 'HP012', 'GV002', 3, '2024-2025', TO_DATE('2025-06-01', 'YYYY-MM-DD'));

INSERT INTO MOMON (MAMM, MAHP, MAGV, HK, NAM, NGAYBD) 
VALUES ('MM021', 'HP013', 'GV001', 3, '2024-2025', TO_DATE('2025-06-01', 'YYYY-MM-DD'));

INSERT INTO MOMON (MAMM, MAHP, MAGV, HK, NAM, NGAYBD) 
VALUES ('MM022', 'HP014', 'GV002', 3, '2024-2025', TO_DATE('2025-06-01', 'YYYY-MM-DD'));

INSERT INTO MOMON (MAMM, MAHP, MAGV, HK, NAM, NGAYBD) 
VALUES ('MM023', 'HP015', 'GV001', 3, '2024-2025', TO_DATE('2025-06-01', 'YYYY-MM-DD'));

INSERT INTO MOMON (MAMM, MAHP, MAGV, HK, NAM, NGAYBD) 
VALUES ('MM024', 'HP016', 'GV002', 3, '2024-2025', TO_DATE('2025-06-01', 'YYYY-MM-DD'));
--drop table dangky;
--drop table momon ;
--drop table hocphan;
--drop table sinhvien;
